...
//        $id = 20;
        ...
        if(!empty($data['keyword'])){
            $where['keyword|title'] = array("like","%".$data['keyword']."%");
        }
        ...
        {
            $distance = getDistance($item['latitude'], $item['longitude'], $userinfo['latitude'],$userinfo['longitude']);
            /*if ($distance<$radius){
                continue;
            }*/
